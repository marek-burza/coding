...
uv run --with-requirements .github/workflows/requirements.txt --no-project coverage run -m pytest . -o python_files="*.py" -p no:cacheprovider --ignore=algorithms/code/other/banking
